...
class BarronBlogSpyder(CrawlSpider):
    name = 'barronblog'
    domain_name = "barronblog"
    start_urls = ['http://blogs.barrons.com/stockstowatchtoday/page/4']
    extra_domain_names = ["localhost"]
    

    rules = (
        Rule(SgmlLinkExtractor(allow='http://blogs.barrons.com/stockstowatchtoday/',
